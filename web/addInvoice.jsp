...
<form action="addInvoice" method="POST">
    ...
    <table>
        <tr>
            ...
            <td class="第二列"><input type="text" name="code" id="code" pattern="([0-9]{10})|([0-9]{12})" title="10或12位数字" maxlength="12" placeholder="10或12位数字" onblur="onBlur('code')" required/></td>
            <td><i id="codeError">应为10或12位数字</i><i id="codeidRepeat">编号代码已存在</i></td>
        </tr>
        <tr>
            <td><label for="id">发票编号：</label></td>
            <td><input type="text" name="id" id="id" pattern="[0-9]{8}" title="8位数字" maxlength="8" placeholder="8位数字" onblur="onBlur(id)" required/></td>
