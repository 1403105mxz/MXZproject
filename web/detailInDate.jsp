...
<body>
    <div class="container bs-docs-container" style="position: relative">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type = "button" class="btn btn-danger" value = "删除"
                                       onclick="delInBusiness('${id}','${pageNumber}','${date}')"/>
                            </td>
                        </tr>
                        <div class="modal fade" id="修改${id}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form action="EditInBusiness.action?pageNumber=${pageNumber}" method="post">
        ...
        <div>
            ...
            <button type="submit" class="btn btn-default" style="position: absolute; right: 15px;" value="返回" onclick="location.href='InOperation'">返回</button>
            <div class="modal fade" id="新增" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="AddInDate.action?pageNumber=${totalPage+1}" method="post">
                            <div class="modal-body">
                                <br/>
                                <div class="input-group">
                                    <span class="input-group-addon">日期</span>
